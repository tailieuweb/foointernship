...
export default {
  data: () => ({
    ...
    headers: [
      ...
      { text: "Pass", value: "chucvu", sortable: false },
      { text: "Quyền", value: "phone", sortable: false },
      { text: "Page", value: "email", sortable: false },
      { text: "Email", value: "namecv", sortable: false },
...
//           },1000);
    ...
    save() {
      if (this.editedIndex > -1) {
        ...
        axios
          .put(
            "https://5fd03fca1f2374001663149f.mockapi.io/instructor" +
              +"/" +
              this.editedItem.id,
            this.editedItem
          )
     ...
     } if(this.editedItem.name=="" || this.editedItem.namecv=="" || this.editedItem.phone=="" || this.editedItem.email==""){
         alert("Yêu cầu Bạn Không Hợp Lệ ?")
       }
      else{
