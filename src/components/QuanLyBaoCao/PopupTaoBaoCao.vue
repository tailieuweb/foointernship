            ...
            <template>
              ...
              >
                <div class="vinh">
                  ...
                  >
                    <v-col md="3">
                      <h3 style="margin-top: 17px" id="tendn1">
                        Tên doanh nghiệp:
                      </h3>
                    </v-col>
                    <v-col md="9">
                  ...
                  >
                    <h4>
                      <i
                        ...
                        style="font-size: 24px; padding-right: 20px"
                      ></i
                      >CHƯƠNG 2: TỰ ĐÁNH GIÁ VÀ NHẬN XÉT THỰC TẬP
                    </h4>
                  </v-toolbar>
                  <v-card-text
                    ><br />
                    <details>
                      <summary>
                        2.1. Nhận thức của HSSV sau thời gian tìm hiểu và tham
                        gia thực tập tại đơn vị.
                      </summary>
                      <p></p>
                    </details>
                    <br /><br />
...
"
                  ...
                  <v-card-text
                    ...
                    <details>
                      <summary>
                        2.2. Mối quan hệ giữa các đồng nghiệp trong tổ hay bộ
                        phận và đơn vị nơi thực tập
                      </summary>
                      <p></p>
                    </details>
                    <br /><br />
...
• HSSV đánh giá được những ưu điểm, nhược điểm từ mối quan hệ này như thế nào nhằm mang đến hiệu quả công việc?"
                  ...
                  <v-card-text
                    ...
                    <details>
                      <summary>
                        2.3. Học hỏi từ các quy định nơi thực tập
                      </summary>
                      <p></p>
                    </details>
                    <br /><br />
                    <h4
                      ...
                      "
                    >
                      • 2.3.1. Nội quy lao động, học tập, nghỉ ngơi và an toàn
                      lao động
                    </h4>
                    <br /><br />
                    <v-textarea
...
"
      ...
      <!-- saving... -->
      <v-dialog v-model="dialog2" hide-overlay persistent width="120">
        <v-card color="#dde2e7" dark>
          <h3
            style="
              text-align: center;
              padding-top: 10px;
      ...
      <v-dialog v-model="dialog3" persistent max-width="290">
        <v-card>
          <v-card-title class="font-weight-bold"> Thông báo </v-card-title>
          <v-card-text class="font-weight-regular"
            >Báo cáo vẫn chưa được lưu. Bạn có muốn thoát?</v-card-text
          >
          <v-card-actions>
            <v-spacer></v-spacer>
            <v-btn color="#1976d2" text @click="dialog3 = false"> Không </v-btn>
            <v-btn
              color="#1976d2"
              text
   ...
   /** WITH CSS */
    ...
    huy() {
      if (
        ...
        document.getElementById("gvhd").value != "" ||
        document.getElementById("hssv").value != "" ||
        document.getElementById("mssv").value != "" ||
        document.getElementById("lop").value != "" ||
        document.getElementById("khoa").value != "" ||
        document.getElementById("loimodau").value != "" ||
        ...
        document.getElementById("tltk").value != ""
      ) {
        this.dialog3 = true;
      } else {
        this.dialog = false;
